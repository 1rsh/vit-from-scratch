...
<br>
The model is trained on [Devanagari Handwritten Character Dataset](https://archive.ics.uci.edu/dataset/389/devanagari+handwritten+character+dataset) available on the [UC Irvine Machine Learning Repository](https://archive.ics.uci.edu/) on an M1 Pro.
<br><br>
****
